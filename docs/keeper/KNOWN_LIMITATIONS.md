...
- This source requires KeeperAuthority 1.7.5, protocol 7, and schema 6. Application
...
- Provider Host installation and enrollment are mechanically separate. The
  1.7.5 Host is release-locked to KeeperAuthority 1.7.5, protocol 7, and schema 6;
