...
- **Related Volumes/ADRs:** DS-011 (Phase 11, DS-RM-015 Optional/Deferred category).
...
- **Promotion Criteria:** Owner review confirming any gamification mechanic does not incentivize excessive trading, overconfidence, or risk-taking (DS-001 §9, §13); dedicated requirement authored only if that review passes.
...
- **Related Volumes/ADRs:** DS-002 (DS-MOB), DS-004 (DS-ARC-003/024).
...
- **Related Volumes/ADRs:** DS-002 (DS-WKS-006), DS-007 (DS-UX-006).
- **Review Gates:** None beyond normal review.
- **Notes:** None.
